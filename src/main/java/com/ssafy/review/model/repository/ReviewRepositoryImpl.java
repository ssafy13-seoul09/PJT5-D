...
public class ReviewRepositoryImpl implements ReviewRepository {
	...
	private ReviewRepositoryImpl() {
		// 생성자는 그냥 가라로 만들어주깅 
		map.put(1, new Review(0, "힘들어요", "ssafy", "엉엉잉잉앙앙", null, 0));
		map.put(2, new Review(0, "운동해서 놀러갈래", "ssafy1", "한강 피크닉가자 낄낄", null, 0));
		map.put(3, new Review(0, "그럴까요", "ssafy2", "사실 집이 제일 좋아 후엥", null, 0));
	}
